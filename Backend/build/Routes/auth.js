  ...
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 8:
          user = rows[0]; // Compara la contraseña
          _context.next = 11;
        ...
        case 18:
          ...
          console.error('Error en el login:', _context.t0.message);
          res.status(500).json({
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 4:
          ...
          existingUser = _yield$db$query2.rows;
        ...
        case 10:
          ...
          _context2.next = 13;
          return db.query('INSERT INTO users (username, password) VALUES ($1, $2) RETURNING id, username', [username, hashedPassword]);
        case 13:
          _yield$db$query3 = _context2.sent;
          newUser = _yield$db$query3.rows;
          // Respuesta exitosa
          res.status(201).json({
        ...
        case 18:
          ...
          console.error('Error en el registro:', _context2.t0.message);
          res.status(500).json({
